...
|---|---|
| bj_bpmh | Blurred meter dial |
| bj_bpps | Broken meter panel |
| bjdsyc | Abnormal meter reading |
| yw_nc | Bird's nest |
| gbps | Cover damage |
| yw_gkxfw | Suspended object |
| hxq_gjbs | Discoloration of respirator silicone |
| sly_dmyw | Oil on the ground |
| wcgz | Not wearing work clothes |

## 4. Dataset Availability  
The full dataset will be made available in this repository after the paper is accepted.
